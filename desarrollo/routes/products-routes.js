...
router.post("/", uploadProduct.single("imagen"), productsController.store); //POST de creacion de producto
//EDIT
router.get("/edit/:id", productsController.edit); //Vista de edicion de producto
router.put("/:id", uploadProduct.single("imagen"), productsController.update); //PUT de edicion de producto
//DELETE
