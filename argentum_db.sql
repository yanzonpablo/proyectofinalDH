...
insert  into `producto_categorias`(`id`,`nombre`,`descripcion`,`imagen`) values (1,'Telefonía móvil','Celulares y accesorios','celular-a52.jpg'),(2,'Computación','Computadoras, notebooks, periféricos y accesorios.','notebook-dell-jh94xwh.jpg'),(3,'Electronica, audio y video','Dispositivos smart para el hogar, equipos de musica, SmartTv.','smart-tv-32.jpg'),(4,'Electrodomésticos','Lavadoras, secadoras, lavavajillas, hornos, microondas, neveras, congeladores y refrigeración en general, campanas extractoras, pequeños electrodomesticos, etc.','cafetera-express-de-longhi.jpg'),(5,'Consolas y videojuegos','Dispositivos electrónicos para el entretenimiento.','ps5.jpg'),(6,'Cuidado personal','Todo lo relacionado al cuidado de la belleza, cosmética y cuidado personal.','afeitadora.jpg');
